...
A single search box, that lets you search many different things.
...
This plugin is the exact [Omnisearch module](http://jetpack.me/support/omnisearch/) of the original Jetpack plugin, only without all the extra stuff.
