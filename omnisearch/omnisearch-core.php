...
class Jetpack_Omnisearch {
	...
	function __construct() {
		...
		// add_action( 'jetpack_admin_menu', array( $this, 'jetpack_admin_menu' ) ); // E-1
	...
	function wp_loaded() {
		require_once( dirname(__FILE__) . '/_inc/genericons.php' ); // E-1
	...
	function admin_print_styles() {
		...
		wp_enqueue_style( 'omnisearch-jetpack' ); // E-1
	}
